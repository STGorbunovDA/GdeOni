...
public sealed class UpdateDeceasedBurialLocationDtoValidator
    : AbstractValidator<UpdateDeceasedBurialLocationDto>
{
    public UpdateDeceasedBurialLocationDtoValidator()
    {
