...
public sealed class CreateDeceasedBurialLocationCommandValidator
    : AbstractValidator<CreateDeceasedBurialLocationCommand>
{
    public CreateDeceasedBurialLocationCommandValidator()
    {
