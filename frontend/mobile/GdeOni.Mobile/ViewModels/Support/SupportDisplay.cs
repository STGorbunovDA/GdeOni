...
internal static class SupportDisplay
{
    public static (string Display, string Color) Status(string code) => code switch
    {
        ...
        // D40. Закрыто принудительно админом — серый: это «сдано в архив»,
        // а не успешное решение. Терминальное состояние.
        "Closed" => ("Закрыто", "#7F8C8D"),
        _ => (code, "#000000"),
    };
    ...
    public static string Kind(string code) => code switch
    {
        ...
        "Complaint" => "Жалоба",
        "Question" => "Вопрос",
        // D33. Новая тема — для сценария "нет фото на карточке умершего,
        // прикладываю свои файлы".
        "Photo" => "Фото",
        "Other" => "Другое",
        _ => code,
    };
